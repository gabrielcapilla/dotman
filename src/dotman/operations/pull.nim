...
import paths, symlinks

proc validatePull*(profiles: var ProfileData, profileId: ProfileId): FileBatch =
...
proc planPullProfile*(profiles: var ProfileData, profileId: ProfileId): ExecutionPlan =
  let profileDir = profiles.getProfilePath(profileId)
  ...
  var linksToRemove = validatePull(profiles, profileId)
